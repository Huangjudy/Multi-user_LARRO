// Copyright (c) Microsoft Corporation.client
...
namespace Microsoft.MixedReality.WebRTC.Unity
{
    ...
    public class NodeDssSignaler : Signaler
    {
        ...
        /// ReceiverNode.
        /// </summary>
        [Tooltip("ReceiverNode")]
        public bool TranformNode = true;
        ...
        private class NodeDssMessage
        {
            ...
            public NodeDssMessage(SdpMessage message)
            {
                ...
                ID = SystemInfo.deviceName;//在message新增ID
            }
            ...
            public NodeDssMessage(IceCandidate candidate)
            {
                ...
                ID = string.Empty;//在message新增ID
            }
            /*
            public NodeDssMessage(String id)
            {
                MessageType = Type.Conn_ID;
                Data = string.Empty;
                IceDataSeparator = string.Empty;
                ID = LocalPeerId;
            }*/
        ...
        private void Start()
        {
            ...
            {
                if (TranformNode == true)
                {
                    LocalPeerId = SystemInfo.deviceName + "_1";
                }
                else
                {
        ...
        private IEnumerator PostToServer(NodeDssMessage msg)
        {
            ...
            msg.ID = SystemInfo.deviceName; //傳給server的ID
        ...
        private IEnumerator CO_GetAndProcessFromServer()
        {
            ...
            if (!www.isNetworkError && !www.isHttpError)
            {
                ...
                if (msg != null)
                {
                    ...
                    DebugLogLong($"Received SDP message: type={msg.MessageType} data={msg.ID}");
                    switch (msg.MessageType)
                    {
                        //case NodeDssMessage.Type.Conn_ID:
                        //LocalPeerId = msg.ID;
                        //DebugLogLong($"Received ID message: type={msg.MessageType} ID={msg.ID}");
                        //break;
