// Copyright (c) Microsoft Corporation.server
        ...
        private IEnumerator CO_GetAndProcessFromServer()
        {
            ...
            if (!www.isNetworkError && !www.isHttpError)
            {
                ...
                if (msg != null)
                {
                    ...
                    DebugLogLong($"Received SDP message: type={msg.MessageType} data={msg.Data} ID={msg.ID}");
